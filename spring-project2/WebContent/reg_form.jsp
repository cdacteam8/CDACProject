				...
				<div class="row">
					...
					<div class="col-lg-7">
						<div class="p-5">
							...
							<spr:form action="reg.htm" modelAttribute="user">
								...
								<div class="form-group">
									<spr:input type="date" path="dateOfBirth"
										class="form-control form-control-user"
										placeholder="Date Of Birth(dd/mm/yyyy)"
										title="Enter valid DOB" required="required"
										pattern="^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$" />
								</div>
								<div class="form-group">
									<spr:input path="emailAddress" 
										class="form-control form-control-user"
								...
								<div>
									<input type="submit" class="btn btn-primary btn-user"
										...
										value="Register"  onclick="checkEmail()"/>
