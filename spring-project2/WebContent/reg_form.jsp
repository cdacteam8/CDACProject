              ...
              <spr:form action="reg.htm" commandName="user" >
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                   ...
                   <spr:input type = "date" path="dateOfBirth"  class="form-control form-control-user"  placeholder="Date Of Birth(dd/mm/yyyy)" title="Enter valid DOB" required="required" pattern="^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group row">
                  ...
                  <spr:input type="hidden" value="candidate" path ="userRole" />
