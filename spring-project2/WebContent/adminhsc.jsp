<%@page import="com.cdac.springproject.dto.HSC"%>
<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
 <%
 	List<HSC> examList = (List<HSC>)request.getAttribute("el");
 %>   
		...
		%>
			<tr>
				...
				<%} %></td>
				 ...
				 <td><a class="btn btn-danger rounded text-light" style="width:200px" href="delete_examhsc.htm?examId=<%=e.getExamId()%>">Delete</a><td>
			</tr>
		<% }  %>
	</table>
