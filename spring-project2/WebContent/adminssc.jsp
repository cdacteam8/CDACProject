...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%
 	List<SSC> examList = (List<SSC>)request.getAttribute("el");
 %>   
		...
		%>
			<tr>
				...
				<%} %></td>
				 ...
				 <td><a class="btn btn-danger rounded text-light" style="width:200px" href="delete_examssc.htm?examId=<%=e.getExamId()%>">Delete</a><td>
			</tr>
		<% }  %>
	</table>
