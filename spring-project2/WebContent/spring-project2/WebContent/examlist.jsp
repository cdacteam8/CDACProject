<%@page import="com.cdac.springproject.dto.ExamMaster"%>
<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
 <%
 	List<ExamMaster> examList = (List<ExamMaster>)request.getAttribute("el");
 %>   
		...
		%>
			<tr>
				...
				<td><%=e.getLinks() %></td>
				 ...
				 <td><a class="btn btn-danger rounded text-light" style="width:200px" href="delete_exam.htm?examId=<%=e.getExamId()%>">Delete</a><td>
			</tr>
		<% }  %>
	</table>
