<%@page import="com.cdac.springproject.dto.Diploma"%>
<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
 <%
 	List<Diploma> examList = (List<Diploma>)request.getAttribute("el");
 %>   
		...
		%>
			<tr>
				...
				<%} %></td>
				 ...
				 <td><a class="btn btn-danger rounded text-light" style="width:200px" href="delete_examdiploma.htm?examId=<%=e.getExamId()%>">Delete</a><td>
			</tr>
		<% }  %>
	</table>
